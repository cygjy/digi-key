...
import com.jd.resource.service.impl.MyRunnable;
...
public class ThreadPoolUtils {
    ...
    public ThreadPoolTaskExecutor taskExecutor() {
        ...
        // 核心线程数
        poolTaskExecutor.setCorePoolSize(i * 2);
        // 最大线程数
        poolTaskExecutor.setMaxPoolSize(i * 2);
        // 队列中最大的数目
        poolTaskExecutor.setQueueCapacity(i * 2 * 10);
        // 线程名称前缀
    ...
    public ThreadPoolExecutor threadPoolExecutor() {
        ...
        int i = Runtime.getRuntime().availableProcessors();
        //核心线程数
        int corePoolSize = i * 3;
        log.info("corePoolSize::" + corePoolSize);
        //最大线程数
        int maximumPoolSize = i * 3;
        log.info("maximumPoolSize::" + corePoolSize);
        //线程无引用存活时间
        ...
        //LinkedBlockingQueue 按照顺序执行
        LinkedBlockingQueue<Runnable> workQueue = new LinkedBlockingQueue<>(i * 2 * 10);
    ...
    /**
     * 基于优先级的阻塞队列，可以按照优先级顺序执行任务
     *
     * @return
     */
    public ThreadPoolExecutor priorityPoolExecutor() {
